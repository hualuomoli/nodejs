...
describe('GET请求转发', function () {
  ...
  it('包含中文URI参数', function (done) {
    request
      .get('/query/1234/' + encodeURIComponent('测试'))
      .query({
        username: 'hualuomoli',
        nickname: '花落莫离'
      })
...
describe('POST请求转发', function () {
  ...
  it('包含中文URI参数', function (done) {
    request
      .post('/send/1234/' + encodeURIComponent('测试'))
      .send({
        username: 'hualuomoli',
        nickname: '花落莫离'
      })
...
describe('文件上传', function () {
  ...
  it('包含中文URI参数', function (done) {
    request
      .post('/upload/1234/' + encodeURIComponent('测试'))
      .field('username', 'hualuomoli')
      .field('nickname', '花落莫离')
      .attach('photo', req(files.photo.url))
      .attach('picture', req(files.picture.url))
